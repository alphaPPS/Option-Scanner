...
def main():
    ...
    for i, ticker in enumerate(tickers, 1):
        ...
        # Weekly % return = (Bid / Strike) * 100
        if result['bid'] and result['strike']:
            weekly_ret = (result['bid'] / result['strike']) * 100
    ...
    headers = [
        ...
        "Delta", "IV%", "OpenInt", "Volume", "Status", "Weekly%", "Annual%"
    ]
    ...
    # ── CSV export ────────────────────────────────────────────────────────────
    csv_path = f"put_scan_{expiry}_d{target_delta:.2f}.csv"
